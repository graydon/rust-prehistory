...
and stmt_alt_tag =
    {
      alt_tag_lval: lval;
      alt_tag_arms: (ident * (slot identified * ident) array * block) array;
    }
...
and crate' =
    {
      ...
      crate_imports: (import_lib, (ident * mod_type_item * span)) Hashtbl.t;
      crate_imported: (node_id, import_lib) Hashtbl.t;
