  ...
  let
    ...
    match id with
      ...
      | SECTION_ID_IMPORTS -> [ IMAGE_SCN_CNT_INITIALIZED_DATA;
                                IMAGE_SCN_MEM_READ;
                                IMAGE_SCN_MEM_WRITE ]
      | SECTION_ID_DEBUG_ARANGES -> [ IMAGE_SCN_MEM_DISCARDABLE ]
      | SECTION_ID_DEBUG_PUBNAMES -> [ IMAGE_SCN_MEM_DISCARDABLE ]
      | SECTION_ID_DEBUG_INFO -> [ IMAGE_SCN_MEM_DISCARDABLE ]
      | SECTION_ID_DEBUG_ABBREV -> [ IMAGE_SCN_MEM_DISCARDABLE ]
      | SECTION_ID_DEBUG_LINE -> [ IMAGE_SCN_MEM_DISCARDABLE ]
